                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid">
                                                <button type="submit" class="btn btn-primary btn-block" id="submit" name="submit"><!-- <a href="login.php"> --> Create account <!-- </a> --></button> </div>
                                            </div>
                                        </form>
                                        <!-- <script>
                                            document.getElementById('register').addEventListener('submit', function(event){
                                                var passwordField = document.getElementById('password');
                                                var reversedPassword = passwordField.value.split(''.reverse().join('');
                                            passwordField.value = reversedPassword;
                                        this.submit();
                                            })
                                            </script> -->
                                    </div>
